...
CREATE TABLE `pedidos` (
  ...
  PRIMARY KEY (`id_ped`,`estoque_id_estoque`),
  UNIQUE KEY `id_ped_UNIQUE` (`id_ped`),
  KEY `fk_pedidos_estoque1_idx` (`estoque_id_estoque`),
  CONSTRAINT `fk_pedidos_estoque1` FOREIGN KEY (`estoque_id_estoque`) REFERENCES `estoque` (`id_estoque`)
...
-- Dump completed on 2019-05-30 18:53:45
